...
<body>
    ...
    <div class="h-[80vh]">
        ...
        <div class="absolute bottom-0 flex justify-center w-full h-20">
            <div id="person-counts"
                class="flex items-center content-center justify-evenly mx-1 overflow-x-hidden bg-gray-800 text-white h-16 rounded-lg w-11/12 shadow-xl">
