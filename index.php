    ...
    <div class="h-[84vh] pb-4">
        ...
        <div id="preferences-table" class="hidden flex flex-col">
            <div class="w-full space-y-10 h-full overflow-x-hidden scroll-style">
                <div class="w-full space-y-4 bg-yellow-100 pb-4 drop-shadow">
                    <div class="drop-shadow flex items-center justify-center space-x-2 text-gray-900 bg-yellow-200 text-2xl font-bold rounded py-2">
                    ...
                    <div class="flex justify-center space-x-3">
                        <button type="button" class="shadow drop-shadow bg-gray-800 text-white font-bold py-3 rounded px-10 hover:bg-gray-700"><a href="./Components/id-printing/index.php">Print IDs</a></button>
                        <button type="button" class="shadow drop-shadow bg-gray-800 text-white font-bold py-3 rounded px-10 hover:bg-gray-700"><a href="">Add a Personnel</a></button>
                    </div>
                </div>

                <div class="w-full space-y-4 pb-4 bg-yellow-100 drop-shadow">
                    <div class="drop-shadow flex items-center justify-center space-x-2 text-gray-900 bg-yellow-200 text-2xl font-bold rounded py-2">
                    ...
                    <div class="mx-2">
                        <div class="flex space-x-2">
                            <button class="flex space-x-2 py-1 pb-3 px-4 rounded-t-lg bg-gray-800 text-white hover:bg-gray-700">
                                ...
                                <h1 class="font-bold text-xl">In and Out Logs</h1>
                            </button>
                            <button class="flex space-x-2 py-1 pb-3 px-4 rounded-t-lg bg-gray-700 text-white hover:bg-gray-800">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-8 w-6 flex-shrink-0 text-gray-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 8h14M5 8a2 2 0 110-4h14a2 2 0 110 4M5 8v10a2 2 0 002 2h10a2 2 0 002-2V8m-9 4h4" />
                                </svg>
                                <h1 class="font-bold text-xl">Meal Logs</h1>
                            </button>
                        </div>
                        <div class="max-h-[475px] shadow-lg">
                            <!-- THEAD -->
                            <div class="sticky z-1">
                                <table class="w-full text-center border-r-2 border-white bg-white rounded">
                                    <thead class="border-b bg-gray-800 cursor-pointer">
                                        <tr>
                                            <th scope="col" class="text-xl font-bold text-white px-6 py-4 hover:bg-gray-700">
                                                NAME
                                            </th>
                                            <th scope="col" class="text-xl font-bold text-white px-6 py-4 hover:bg-gray-700">
                                                EVENT
                            ...
                            <!-- TBODY -->
                            <div class="max-h-[422px] overflow-y-auto scroll-style">
                                <table class="w-full text-center border-r-2 border-white bg-white rounded">
                                    <tbody>
                                        <?php
                                        include './dbh.inc.php';
