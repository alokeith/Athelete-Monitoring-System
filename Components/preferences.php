        ...
        <div class="w-full space-y-4 pb-4 bg-yellow-100 drop-shadow">
            ...
            <div class="mx-2">
                <div class="flex space-x-2 -space-y-1">
                    <button class="py-1 pb-3 px-4 rounded bg-gray-800 text-white hover:bg-gray-700">
                        <h1 class="font-bold text-xl">In and Out Logs</h1>
                    </button>
                    <button class="py-1 pb-3 px-4 rounded bg-gray-700 text-white hover:bg-gray-700">
                        <h1 class="font-bold text-xl">Meal Logs</h1>
                    </button>
                </div>
                <div class="h-[428px] overflow-y-auto">
                                ...
                                while ($row = $result->fetch_assoc()) {
                                    ...
                                    echo '
                                            <tr class="border-b even:bg-gray-100">
                                                <td class="px-6 py-4 whitespace-nowrap text-sm font-bold text-gray-900">' . $row["person_name"] . '
                                                </td>
